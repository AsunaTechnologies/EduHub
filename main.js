        ...
        return {
            ...
            pages: {
                ...
                profile: {
                    en: {
                        title: 'Profile',
                        subtitle: 'Manage your documents, saved universities, and send applications.',
                        guestUser: 'Guest User',
                        personalInfo: 'Personal Info',
                        documents: 'Documents',
                        bookmarks: 'Bookmarked Universities',
                        ...
                        universitiesBookmarked: 'Universities Bookmarked',
                        applicationsSent: 'Applications Sent',
                        myDocuments: 'My Documents',
                        ieltsCert: 'IELTS Certificate',
                        ieltsDesc: 'Upload your IELTS test results',
                        transcript: 'School Transcript',
                        transcriptDesc: 'Upload your academic transcript',
                        recommendation: 'Recommendation Letter',
                        recommendationDesc: 'Upload recommendation from teacher',
                        entCert: 'UNE/ENT Certificate',
                        entDesc: 'Kazakhstan national exam results',
                        satCert: 'SAT Certificate',
                        satDesc: 'Upload your SAT score report',
                        upload: 'Upload',
                        readyToApply: 'Ready to Apply?',
                        sendDocsDesc: 'Send your documents to your bookmarked universities. We\'ll notify you when they start accepting applications.',
                        sendToUniversity: 'Send to University',
                        bookmarkedUniversities: 'Bookmarked Universities',
                        addMore: 'Add More',
                        noBookmarks: 'No Bookmarked Universities',
                        noBookmarksDesc: 'Start exploring universities and bookmark your favorites to track them here.',
                        exploreNow: 'Explore Universities',
                        noApplications: 'No Applications Sent Yet',
                        noApplicationsDesc: 'Upload your documents and send them to your bookmarked universities.',
                        uploadDocs: 'Upload Documents',
                        selectUniversities: 'Select Universities',
                        selectUnisDesc: 'Choose which universities to send your documents to',
                        cancel: 'Cancel',
                        next: 'Next',
                        confirmSend: 'Confirm & Send',
                        confirmDesc: 'Enter your email to receive confirmation',
                        yourEmail: 'Your Email',
                        notificationNote: 'You will receive a notification when universities start accepting documents.',
                        selectedUnisLabel: 'Selected Universities:',
                        back: 'Back',
                        sendApplication: 'Send Application',
                        applicationSubmitted: 'Application Submitted!',
                        successMessage: 'Your documents have been queued. You will receive an email notification when universities start accepting applications.',
                        done: 'Done',
                        bookmark: 'Bookmark',
                    ...
                    ru: {
                        title: 'Профиль',
                        subtitle: 'Управляйте документами, сохранёнными университетами и отправляйте заявки.',
                        guestUser: 'Гость',
                        personalInfo: 'Личные данные',
                        documents: 'Документы',
                        bookmarks: 'Избранные университеты',
                        sentApplications: 'Отправленные заявки',
                        save: 'Сохранить',
                        firstName: 'Имя',
                        lastName: 'Фамилия',
                        email: 'Email адрес',
                        phone: 'Номер телефона',
                        documentsUploaded: 'Загружено документов',
                        universitiesBookmarked: 'Университетов в избранном',
                        applicationsSent: 'Заявок отправлено',
                        myDocuments: 'Мои документы',
                        ieltsCert: 'Сертификат IELTS',
                        ieltsDesc: 'Загрузите результаты теста IELTS',
                        transcript: 'Школьный аттестат',
                        transcriptDesc: 'Загрузите ваш аттестат',
                        recommendation: 'Рекомендательное письмо',
                        recommendationDesc: 'Загрузите рекомендацию от учителя',
                        entCert: 'Сертификат ЕНТ',
                        entDesc: 'Результаты национального экзамена',
                        satCert: 'Сертификат SAT',
                        satDesc: 'Загрузите результаты SAT',
                        upload: 'Загрузить',
                        readyToApply: 'Готовы подать заявку?',
                        sendDocsDesc: 'Отправьте документы в избранные университеты. Мы уведомим вас, когда они начнут приём.',
                        sendToUniversity: 'Отправить в университет',
                        bookmarkedUniversities: 'Избранные университеты',
                        addMore: 'Добавить ещё',
                        noBookmarks: 'Нет избранных университетов',
                        noBookmarksDesc: 'Изучайте университеты и добавляйте их в избранное для отслеживания.',
                        exploreNow: 'Смотреть университеты',
                        noApplications: 'Заявок ещё не отправлено',
                        noApplicationsDesc: 'Загрузите документы и отправьте их в избранные университеты.',
                        uploadDocs: 'Загрузить документы',
                        selectUniversities: 'Выберите университеты',
                        selectUnisDesc: 'Выберите университеты для отправки документов',
                        cancel: 'Отмена',
                        next: 'Далее',
                        confirmSend: 'Подтвердить и отправить',
                        confirmDesc: 'Введите email для получения подтверждения',
                        yourEmail: 'Ваш Email',
                        notificationNote: 'Вы получите уведомление, когда университеты начнут приём документов.',
                        selectedUnisLabel: 'Выбранные университеты:',
                        back: 'Назад',
                        sendApplication: 'Отправить заявку',
                        applicationSubmitted: 'Заявка отправлена!',
                        successMessage: 'Ваши документы добавлены в очередь. Вы получите email-уведомление когда университеты начнут приём.',
                        done: 'Готово',
                    ...
                    kz: {
                        title: 'Профиль',
                        subtitle: 'Құжаттарыңызды, сақталған университеттерді басқарыңыз және өтініштер жіберіңіз.',
                        guestUser: 'Қонақ',
                        personalInfo: 'Жеке мәліметтер',
                        documents: 'Құжаттар',
                        bookmarks: 'Таңдаулы университеттер',
                        sentApplications: 'Жіберілген өтініштер',
                        save: 'Сақтау',
                        firstName: 'Аты',
                        lastName: 'Тегі',
                        email: 'Email мекенжайы',
                        phone: 'Телефон нөмірі',
                        documentsUploaded: 'Жүктелген құжаттар',
                        universitiesBookmarked: 'Таңдаулы университеттер',
                        applicationsSent: 'Жіберілген өтініштер',
                        myDocuments: 'Менің құжаттарым',
                        ieltsCert: 'IELTS сертификаты',
                        ieltsDesc: 'IELTS тест нәтижелерін жүктеңіз',
                        transcript: 'Мектеп аттестаты',
                        transcriptDesc: 'Аттестатыңызды жүктеңіз',
                        recommendation: 'Ұсыныс хаты',
                        recommendationDesc: 'Мұғалімнен ұсыныс жүктеңіз',
                        entCert: 'ҰБТ сертификаты',
                        entDesc: 'Ұлттық емтихан нәтижелері',
                        satCert: 'SAT сертификаты',
                        satDesc: 'SAT нәтижелерін жүктеңіз',
                        upload: 'Жүктеу',
                        readyToApply: 'Өтініш беруге дайынсыз ба?',
                        sendDocsDesc: 'Құжаттарыңызды таңдаулы университеттерге жіберіңіз. Қабылдау басталғанда хабарлаймыз.',
                        sendToUniversity: 'Университетке жіберу',
                        bookmarkedUniversities: 'Таңдаулы университеттер',
                        addMore: 'Тағы қосу',
                        noBookmarks: 'Таңдаулы университеттер жоқ',
                        noBookmarksDesc: 'Университеттерді зерттеп, таңдаулыға қосыңыз.',
                        exploreNow: 'Университеттерді қарау',
                        noApplications: 'Өтініштер әлі жіберілмеген',
                        noApplicationsDesc: 'Құжаттарды жүктеп, таңдаулы университеттерге жіберіңіз.',
                        uploadDocs: 'Құжаттарды жүктеу',
                        selectUniversities: 'Университеттерді таңдаңыз',
                        selectUnisDesc: 'Құжаттарды жіберу үшін университеттерді таңдаңыз',
                        cancel: 'Болдырмау',
                        next: 'Келесі',
                        confirmSend: 'Растау және жіберу',
                        confirmDesc: 'Растау үшін email енгізіңіз',
                        yourEmail: 'Сіздің Email',
                        notificationNote: 'Университеттер құжаттарды қабылдай бастағанда хабарландыру аласыз.',
                        selectedUnisLabel: 'Таңдалған университеттер:',
                        back: 'Артқа',
                        sendApplication: 'Өтінішті жіберу',
                        applicationSubmitted: 'Өтініш жіберілді!',
                        successMessage: 'Құжаттарыңыз кезекке қосылды. Университеттер қабылдауды бастағанда email хабарландыру аласыз.',
                        done: 'Дайын',
                        bookmark: 'Таңдаулыға',
                        bookmarked: 'Таңдаулыда'
                    }
                }
            }
        };
